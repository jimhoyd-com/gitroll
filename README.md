...
- **Straight into writing:** bookmark `#/new` — it opens with the cursor in the box. Anything you type and don't save comes back the next time you open the app.
- **Name it:** click the Roll's name in the header. What you call it here is what `--roll` takes in the terminal.
