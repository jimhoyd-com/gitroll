...
From 0.3.0 onward GitRoll ships under the [PolyForm Shield License 1.0.0](../LICENSE).
...
- `LICENSE-MIT-HISTORICAL` — the record that 0.2.0 and earlier were MIT. Keep
  shipping it. It is what makes the boundary verifiable, and it costs nothing.

Also:

- **Never delete or re-tag the v0.1.0–v0.2.0 releases.** Those versions are MIT
