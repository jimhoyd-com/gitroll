...
export const AGENT_GUIDE = {
  ...
  instructions: [
    ...
    "--json implies --non-interactive: no GitRoll prompts, editors or workspace/browser launches. Unsupported JSON modes and flags fail before execution. --dry-run is supported only by migrate and adopt; never assume it applies to log or other writes. Explicit --yes is required for confirmation in noninteractive mode.",
